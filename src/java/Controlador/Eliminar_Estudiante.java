 ...
 * @author Romario
 */
@WebServlet(urlPatterns = {"/eliminar_estudiante.do"})
public class Eliminar_Estudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String codigoEstudiante=request.getParameter("estudiante-a-eliminar");
        String codigoMateria=(String)request.getSession().getAttribute("codigoMateria");
        if(sistema.eliminarEstudianteDeMateria(codigoEstudiante, codigoMateria)){
            ...
            request.getSession().setAttribute("codigoMateria", codigoMateria);
            request.getRequestDispatcher("./Vista/ErrorEliminarEstudiante.jsp").forward(request, response);
        }
    }
